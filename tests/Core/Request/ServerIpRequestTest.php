...
class ServerIpRequestTest extends TestCase
{
    public function testAll(): void
    {
        ...
        static::assertSame(ServerIpRequest::URL, $request->getUrl());
    ...
    public static function createRequest(): ServerIpRequest
    {
        $request = new ServerIpRequest();
